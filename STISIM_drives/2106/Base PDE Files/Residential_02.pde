...
// Difficult version 1
    ...
    @25000, Vehicles, 1300, -4{0}, 60{0}, 3, F*1~56; S*1~53; T*1~28, 1, 1
    @25000, Vehicles, 1600, -4{0}, 60{0}, 3, F*1~56; S*1~53; T*1~28, 1, 1
    @25000, Vehicles, 1900, -4{0}, 60{0}, 3, F*1~56; S*1~53; T*1~28, 1, 1
    
    // Add some background pedestrians
    
    @22300, Pedestrian, 0, 20, 6, 7{1}, B, *1~5; 8; 12~16; 27~30; 35
    @23100, Pedestrian, 0, 10, 6, 9{1}, B, *1~3
    @25200, Pedestrian, 0, 10, 4, 2{1}, B, *1~5; 8; 12~16; 27~30; 35
    @25600, Pedestrian, 0, 10, 4.5, -4{2}, F, *1~5
...
// Difficult version 2
    ...
    @35400, Vehicles, 0, -7{0}, 0{0}, 3, SP16, 1, 0, 4000{20}, 2, 10{0}, , , 2
    
    // Add some background pedestrians
    
    @32300, Pedestrian, 0, 20, 6, 9{1}, B, *1~5; 8; 12~16; 27~30; 35
    @32600, Pedestrian, 0, 40, 6.5, 11{1}, F, *1~5
    @35200, Pedestrian, 0, 10, 4, 6{1}, B, *1~5; 8; 12~16; 27~30; 35
    @35600, Pedestrian, 0, 10, 4.5, 11{1}, F, *1~5
    ...
    @35500, Pedestrian, 0, 10, 4, -10{2}, B, *1~3
    @35800, Pedestrian, 0, 10, 4.5, -8{2}, F, *1~5; 8; 12~16; 27~30; 35
...
@44420, Vehicles#3, 0, -36{0}, 0{0}, 2, F*18~21; F*41~44, 1, 1, 5{0}, 2, -22{0}, , , 2, {25}, 2, 0{0}, , , 2, 2.5{26}, 7, 1, 13, {25}, 2, 35{0}, , , 4, 
    ...
    @45200, Pedestrian, 0, 10, 4, 4{1}, B, *1~5; 8; 12~16; 27~30; 35
    @45600, Pedestrian, 0, 10, 4, 6{1}, F, *1~5
